...
MAX_SPEED = 30.0  # km/h
SAVE_EVERY_N_STEPS = 20  # 10ms × 20 = 200ms = 5 FPS
...
while robot.step() != -1 and image_count < TOTAL_IMAGES and running:
    ...
    # === Image Capture ===
    if current_speed > 0.0 and step_count % SAVE_EVERY_N_STEPS == 0:
        ...
        print(f"[{image_count}/{TOTAL_IMAGES}] Captured | Speed: {current_speed:.1f} km/h | Steering: {steering_angle:.2f}")
